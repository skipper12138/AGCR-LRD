...
load 'huanghekou_data.mat'; load 'huanghekou_samples.mat';
huanghekou_data = double(huanghekou_data);  
DCM =huanghekou_data./(max(huanghekou_data(:)));
clear huanghekou_data;
proporition=0.99;
[m,n,d]=size(DCM);
redata=reshape(DCM,m*n,d); 
...
save('HHK_ERS_LABELS_2000.mat','labels','-V7');
%load ERS_LABELS_500.mat
