...
% show ROC (PF, PD)
% %定义一个颜色矩阵
% cl=[160/256,32/256,240/256;0.5,0.5,0.5;1,0,0;0,0,1;1,97/256,0;0,1,1;0,1,0;0,0,0;1,0.5,0;0.5,1,0.5];
% figure;
% for j=1:num_map
% %     plot(PF2(:,j),PD2(:,j),'color',cl(j,:),'LineWidth',3);   % 横坐标为常规数字
%     semilogx(PF2(:,j),PD2(:,j),'color',cl(j,:),'LineWidth',3); % 横坐标为对数数字
%     hold on;
% end
% axis([0,1,0,1]);
% 
% % set(gca,'XTick',(0:0.2:1),'fontsize',16,'FontName','Times New Roman','FontWeight','bold');   % 横坐标为常规数字
% set(gca,'XTick',[0.0001,0.001,0.01,0.1,1],'fontsize',16,'FontName','Times New Roman','FontWeight','bold');  % 横坐标为对数数字
% set(gca,'YTick',(0:0.2:1),'fontsize',16,'FontName','Times New Roman','FontWeight','bold');
% xlabel('P_F','fontsize',18,'FontWeight','bold') ; ylabel('P_D','fontsize',18,'FontWeight','bold');
...
% figure;
% for j=1:num_map
%     plot(tau2(:,j),PD2(:,j),'color',cl(j,:),'LineWidth',3);    % 横坐标为常规数字
% %     semilogx(tau2(:,j),PD2(:,j),'color',cl(j,:),'LineWidth',3);  % 横坐标为对数数字
%     hold on;
% end
% axis([0,1,0,1]);
% set(gca,'XTick',(0:0.2:1),'fontsize',16,'FontName','Times New Roman','FontWeight','bold'); % 横坐标为常规数字
% % set(gca,'XTick',[0.0001,0.001,0.01,0.1,1],'fontsize',16,'FontName','Times New Roman','FontWeight','bold');  % 横坐标为对数数字
% set(gca,'YTick',(0:0.2:1),'fontsize',16,'FontName','Times New Roman','FontWeight','bold');
% xlabel('\tau','fontsize',18,'FontWeight','bold') ; ylabel('P_D','fontsize',18,'FontWeight','bold');
...
% figure;
% for j=1:num_map 
% %     plot(tau2(:,j),PF2(:,j),'color',cl(j,:),'LineWidth',3);  % 横坐标为常规数字
%     semilogx(tau2(:,j),PF2(:,j),'color',cl(j,:),'LineWidth',3); % 横坐标为对数数字
%     hold on;
% end
% axis([0,1,0,1]);
% % set(gca,'XTick',(0:0.2:1),'fontsize',16,'FontName','Times New Roman','FontWeight','bold');   % 横坐标为常规数字
% set(gca,'XTick',[0.0001,0.001,0.01,0.1,1],'fontsize',16,'FontName','Times New Roman','FontWeight','bold');  % 横坐标为对数数字
% set(gca,'YTick',(0:0.2:1),'fontsize',16,'FontName','Times New Roman','FontWeight','bold');
% xlabel('\tau','fontsize',18,'FontWeight','bold') ; ylabel('P_F','fontsize',18,'FontWeight','bold');
...
% end
% % added by LinSheng
% % legend('RX','CRD','LSMAD','LSDM-MoG','RGAE','GAED','NJCR','Proposed');
% 
% axis([0, 1, 0, 1, 0, 1]);
% set(gca,'XTick',(0:0.2:1),'fontsize',16,'FontName','Times New Roman','FontWeight','bold');
% set(gca,'YTick',(0:0.2:1),'fontsize',16,'FontName','Times New Roman','FontWeight','bold');
% set(gca,'ZTick',(0:0.2:1),'fontsize',16,'FontName','Times New Roman','FontWeight','bold');
% xlabel('P_F','fontsize',18,'FontWeight','bold') ; ylabel('\tau','fontsize',18,'FontWeight','bold'); zlabel('P_D','fontsize',18,'FontWeight','bold');
% grid on;
% ax = gca;
% ax.BoxStyle = 'full';
% box on;
